...
minus_cp_data_3 = np.genfromtxt(project_folder + 'mean_cp/'+'mean_cp_reference_dns.csv', delimiter=',')
minus_cp_data_4 = np.genfromtxt(project_folder + 'mean_cp/'+'mean_cp_damp_corrected2.csv', delimiter=',')
#############################################################################################
#                                        Calculate profile                      #
#############################################################################################
...
minus_cp_4 = minus_cp_data_4[:, 0:]

# Coordinate adjustment
minus_cp[:, 0] -= 0.15
minus_cp_2[:, 0] -= 0.15
minus_cp_2011[:, 0] -= 0.15
minus_cp_3[:, 0] -= minus_cp_3[-1,0]
minus_cp_4[:, 0] -= minus_cp_4[-1,0]
...
plt.plot(minus_cp_3[:, 0], minus_cp_3[:, 1], label='3D DNS Reference', color=profile_color[1],linewidth=linewidth_list[0], linestyle='-')
plt.plot(minus_cp_3[:, 0], minus_cp_3[:, 2], label='', color=profile_color[1],linewidth=linewidth_list[0], linestyle='--')
...
plt.savefig(project_folder + 'temp_mean_cp.jpg', dpi=300)
