...
cfd_array_list = []
#Read CFD result
data_folder_list = ['temp_3D-CD-8deg-2011/','temp_3D-CD-8deg-2011/hdf5/area_weighted/']
...
for i,n in enumerate(plot_list):
	...
	for j,data_name in enumerate(['3D DNS','3D DNS (HDF5)']):
	...
	plt.savefig(project_folder + 'wall_psd/temp_3D-CD-8deg-2011/hdf5/temp_wall_psd_probe_{}.pdf'.format(n))
	#plt.savefig(project_folder + 'wall_psd/temp_3D-CD-8deg-2011/hdf5/temp_wall_p_hist_probe_{}.pdf'.format(n))
	plt.close()
