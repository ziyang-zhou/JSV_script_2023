...
#Load Direct results
spectrum6 = np.loadtxt('/home/ziyz1701/storage/CD_airfoil/AIAA_2023_paper_plot/farfield_SPL/DNS_SLRT/direct/psd_pressure_r1_06_3D_corrected_u4.txt')
spectrum7 = np.loadtxt('/home/ziyz1701/storage/CD_airfoil/AIAA_2023_paper_plot/farfield_SPL/DNS/direct/psd_pressure_r1_06_3D_corrected_u4.txt')
spectrum8 = np.loadtxt('/home/ziyz1701/storage/CD_airfoil/AIAA_2023_paper_plot/farfield_SPL/DNS_SLR/direct/psd_pressure_r1_06_3D_corrected_u4.txt')
...
plt.ylabel('Power Spectral Density dB/Hz', fontsize=fontsize_var*1.3, fontweight='bold')
plt.tight_layout()
plt.savefig(project_folder + 'direct_noise_3D_corrected_u4.pdf', dpi=300)
plt.close()
